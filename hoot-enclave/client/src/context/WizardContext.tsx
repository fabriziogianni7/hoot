...
interface WizardContextType {
  ...
  submittedInputs: QuestionOptions | null
  ...
  setSubmittedInputs: (inputs: QuestionOptions | null) => void
...
export const WizardProvider: React.FC<WizardProviderProps> = ({ children }) => {
  ...
  const [submittedInputs, setSubmittedInputs] = useState<QuestionOptions | null>(null)
