...
const STEPS: StepConfig[] = [
  ...
  { step: WizardStep.GUESS, path: '/step5', component: Guess, icon: NumberSquareFiveIcon },
  { step: WizardStep.ENCRYPT_SUBMIT, path: '/step6', component: EncryptSubmit, icon: NumberSquareSixIcon },
  { step: WizardStep.RESULTS, path: '/step7', component: Results, icon: NumberSquareSevenIcon },
]
