...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../../../common.js"
  ...
  export interface MockNaiveRegistryFilterInterface extends Interface {
    getFunction(nameOrSignature: "committees" | "initialize" | "owner" | "publishCommittee" | "registry" | "renounceOwnership" | "requestCommittee" | "setRegistry" | "transferOwnership"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface MockNaiveRegistryFilter extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockNaiveRegistryFilter;
    waitForDeployment(): Promise<this>;

    interface: MockNaiveRegistryFilterInterface;
