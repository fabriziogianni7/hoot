...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../../../common.js"
  ...
  export interface MockCiphernodeRegistryInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'requestCommittee', data: BytesLike): Result;
  ...
  export interface MockCiphernodeRegistry extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockCiphernodeRegistry;
    waitForDeployment(): Promise<this>;

    interface: MockCiphernodeRegistryInterface;
