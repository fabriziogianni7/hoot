...
// forge script script/DeployBonusBaseSepolia.s.sol \
//   --rpc-url https://base-sepolia.drpc.org \
//   --broadcast
contract DeployBonusBaseSepoliaScript is Script {
    function run() external {
        ...
        HootBonusQuizManager quizManager = new HootBonusQuizManager(
            treasury,
            treasuryFeePercent,
            feePrecision
        );
        ...
        console.log("HootBonusQuizManager deployed to Base Sepolia at:", address(quizManager));
